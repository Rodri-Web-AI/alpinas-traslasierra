...
const MODELS = [
  {
    ...
    price: [
      ...
      "📊 ROI: 49.3% anual",
      "⏱ Retorno: 24 meses (2 años)",
      "💰 Alquiler estimado: $900.000/mes",
    ],
    bedrooms: 1,
    bathrooms: 1,
  ...
  },
  {
    ...
    price: [
      ...
      "📊 ROI: 51.4% anual (el más alto)",
      "⏱ Retorno: 23 meses (1.9 años)",
      "💰 Alquiler estimado: $1.350.000/mes",
    ],
    bedrooms: 2,
    bathrooms: 1,
  ...
  },
  {
    ...
    price: [
      ...
      "📊 ROI: 49% anual",
      "⏱ Retorno: 24 meses",
      "💰 Alquiler estimado: $1.250.000/mes",
    ],
    bedrooms: 2,
    bathrooms: 2,
